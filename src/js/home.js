...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const headerWhatTitle = document.querySelector('.explanation-container__title p')
  const headerWhat = new SplitText(document.querySelector('.explanation-container__text'), {
    type: 'lines'
  })
  const headerTechTitle = document.querySelector('.tech-used .title-container .title')
  const headerTechList = document.querySelectorAll('.tech-used .tech-list')
  const headerGraphismTitle = document.querySelector('.graphism-used .title-container .title')
  const headerGraphismList = document.querySelectorAll('.graphism-used .tech-list')
  ...
  tlHeader.from(headerWhatTitle, 0.6, {
      y: 30,
    })
    .staggerFrom(headerWhat.lines, 1.2, {
      y: 60,
      opacity: 0
    }, 0.08, '-=0.6')
    .from(headerTechTitle, 0.6, {
      y: 30
    }, '-=1')
    .staggerFrom(headerTechList, 0.8, {
      y: 20,
      opacity: 0
    }, 0.1, '-=0.5')
    .from(headerGraphismTitle, 0.6, {
      y: 30
    }, '-=1.2')
    .staggerFrom(headerGraphismList, 0.8, {
      y: 20,
      opacity: 0
    }, 0.1, '-=0.8')
  ...
  if (window.innerWidth > 900) {
    tlHome.staggerFrom(homeTitle, 1, {
        y: 80
      }, 0.1)
      .from(homeImage, 0.6, {
        y: 20,
  ...
  console.log(blockIntroduction)
  const blockIntroductionWatcher = scrollmonitor.create(blockIntroduction, -300)
  const blockIntroductionText1 = new SplitText(blockIntroduction.querySelector('.text-1 p'), {
    type: 'lines'
  })
  splitTextContainer.push(blockIntroductionText1)
  const blockIntroductionText2 = new SplitText(blockIntroduction.querySelector('.text-2 p'), {
    type: 'lines'
  })
  ...
  tlIntro.staggerFrom(blockIntroductionText1.lines, 0.8, {
      y: 40,
      opacity: 0
    }, 0.08)
    .staggerFrom(blockIntroductionText2.lines, 0.8, {
      y: 40,
      opacity: 0
    }, 0.08, '-=0.6')
